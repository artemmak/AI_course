...
dfs(Max_curent,[CL1,ML1,B1,CR1,MR1],[CL2,ML2,B2,CR2,MR2],Explored,MovesList) :- 
   move([CL1,ML1,B1,CR1,MR1],[CL3,ML3,B3,CR3,MR3]), 
   Max is Max_curent - 1,
   not(member([CL3,ML3,B3,CR3,MR3],Explored)),
   dfs(Max,[CL3,ML3,B3,CR3,MR3],[CL2,ML2,B2,CR2,MR2],[[CL3,ML3,B3,CR3,MR3]|Explored],[ [[CL3,ML3,B3,CR3,MR3],[CL1,ML1,B1,CR1,MR1]] | MovesList ]).

% Solution found
dfs(Max,[CL,ML,B,CR,MR],[CL,ML,B,CR,MR],_,MovesList):- 
    Max > 0,
	output(MovesList).
...
go_to_solution :- 
   dfs(12,[3,3,left,0,0],[0,0,right,3,3],[[3,3,left,0,0]],_).
